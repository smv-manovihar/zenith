[Skip to content](https://docs.anilist.co/guide/graphql/queries/media-list#VPContent)

On this page

# Media List [​](https://docs.anilist.co/guide/graphql/queries/media-list\#media-list)
...
## Get a single list entry [​](https://docs.anilist.co/guide/graphql/queries/media-list\#get-a-single-list-entry)
...
### By entry ID [​](https://docs.anilist.co/guide/graphql/queries/media-list\#by-entry-id)
...
### By media ID [​](https://docs.anilist.co/guide/graphql/queries/media-list\#by-media-id)
...
### From the `Media` object [​](https://docs.anilist.co/guide/graphql/queries/media-list\#from-the-media-object)
...
## Get a full list [​](https://docs.anilist.co/guide/graphql/queries/media-list\#get-a-full-list)
