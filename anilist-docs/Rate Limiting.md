[Skip to content](https://docs.anilist.co/guide/rate-limiting#VPContent)

On this page

# Rate Limiting [​](https://docs.anilist.co/guide/rate-limiting\#rate-limiting)
...
## Burst Limiting [​](https://docs.anilist.co/guide/rate-limiting\#burst-limiting)
...
## Rate Limit Raise [​](https://docs.anilist.co/guide/rate-limiting\#rate-limit-raise)
...
You can send an email to [contact@anilist.co](mailto:contact@anilist.co) with the following information:

Title: Rate Limit Raise
