[Skip to content](https://docs.anilist.co/guide/graphql/queries/media#VPContent)

On this page

# Media [​](https://docs.anilist.co/guide/graphql/queries/media\#media)
...
`Media` encompasses both anime and manga entries, so if you are looking for a specific type of media, you will need to use the `type` argument. IDs are not unique across either type of media. If ID `1` is an anime entry, there will never be a manga entry with the same ID.
...
## Get media by ID [​](https://docs.anilist.co/guide/graphql/queries/media\#get-media-by-id)
...
## Search anime by title [​](https://docs.anilist.co/guide/graphql/queries/media\#search-anime-by-title)
...
Notice how it is now wrapped in a `Page` object. This allows it to return multiple results, and also allows you to paginate through the results. For more information on pagination, check out the [pagination](https://docs.anilist.co/guide/graphql/pagination) guide.
...
## Get the relations of a media [​](https://docs.anilist.co/guide/graphql/queries/media\#get-the-relations-of-a-media)
...
Since `relations` is a connection, we will need to use the `edges` field to know how the related media are connected. You can read more about how connections work [here](https://docs.anilist.co/guide/graphql/connections).
...
## Get all light novels from 2020 [​](https://docs.anilist.co/guide/graphql/queries/media\#get-all-light-novels-from-2020)
...
## Advanced browse page [​](https://docs.anilist.co/guide/graphql/queries/media\#advanced-browse-page)
